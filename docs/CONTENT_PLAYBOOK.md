...
- ❌ **1:1 이 아닌 인물·캐릭터 이미지** (예: 192×410 같은 세로 긴 사진) → 시각적으로 왜곡되어 보임. **모든 인물·일러스트 자산은 1:1 native ratio 로 export** 하거나 1:1 frame 으로 crop. hero-deco·avatar·thumbnail 모두 적용
